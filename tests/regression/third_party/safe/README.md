...
cargo run -r --bin jacquard -- map safe_synth.gv safe_test.gemparts

# Simulate with Metal
cargo run -r --features metal --bin jacquard -- sim safe_synth.gv safe_test.gemparts safe.vcd gem_output_safe.vcd 48 --input-vcd-scope safe_tb
```
